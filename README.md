...
To translate overassessment into dollar impact, I joined town-level mill rate data from two Connecticut sources covering 2005–2026. For each overassessed property, the excess assessed value × (mill rate / 1000) gives the annual tax overpayment.
...
Key Findings
Pre-crash (2006–2008): Homes were slightly underassessed — the median accuracy ratio sat around 0.85, meaning assessments lagged behind rapidly appreciating prices.
...
Visualizations
Assessment Accuracy Over Time (main plot) — Line chart showing median accuracy ratio 2006–2024 with the 2008 crash marked and the 8-year overassessment window shaded in red.
County Map Timeline (supporting) — Five small-multiple choropleth maps at key years (2007, 2009, 2011, 2016, 2020) showing the geographic spread using a diverging blue–white–red palette.
Total Statewide Overpayment by Year — Bar chart of aggregate dollar overpayment 2009–2016 with labeled values.
Median Per-Home Overpayment — Line + area chart of median annual tax overpayment per property.
County Accuracy Shift (2007 → 2011) — Horizontal bar chart ranking counties by magnitude of shift toward overassessment.
Median Home Sale Price Over Time (descriptive) — Shows the price drop and recovery arc for context.
Residential Sales Volume by Year (descriptive) — Bar chart of transaction counts across pre-crash, crash, and recovery periods.
Tech Stack
...
Data
Primary: Connecticut Open Data Portal — Real Estate Sales by Town
...
Mill rates: Two CT datasets — Grand List Years 2012–1991 Mill Rates and Mill Rates for FY 2014–2026, both from CT open data.

Crosswalk: CT Town-County FIPS List — maps 169 towns to 8 counties.

Dataset complexity score: (14 × 4) × (800,000 / 100) = 448,000 (requirement: ≥ 100)

Data files are not included in this repo. See links above to download.
